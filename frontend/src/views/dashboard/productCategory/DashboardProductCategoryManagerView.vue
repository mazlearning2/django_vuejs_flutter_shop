<template>
  ...
  >
    <div class="col-span-12 flex items-center justify-between">
      <RouterLink
        :to="{ name: 'dashboardProductCategoryCreatedView' }"
    ...
    <div class="col-span-12 grid grid-cols-12 border-b-4 border-b-base-100 p-2">
      <div class="col-span-3 border-l border-l-base-100">
        <h1 class="font-bold text-center">عنوان دسته بندی</h1>
      </div>
      <div class="col-span-3 border-l border-l-base-100">
        <h1 class="font-bold text-center">تصویر دسته بندی</h1>
      </div>
      <div class="col-span-3 border-l border-l-base-100">
        <h1 class="font-bold text-center">وضعیت دسته بندی</h1>
      </div>
      <div class="col-span-3">
        <h1 class="font-bold text-center">عملایت ها</h1>
      </div>
    </div>
    <template v-if="productCategoryStore.categories.length !== 0">
      <div
      ...
      >
        ...
        >
          <h1 class="font-bold text-center">
            <span class="badge badge-success" v-if="category.status">فعال</span>
        ...
        <div class="col-span-3 flex items-center justify-center gap-5">
          <button
            ...
            @click="
              productCategoryStore.showDeleteModalProductCategoryHandler(
                category
              )
            "
          >
          ...
          <dialog id="productCategoryDeleteModal" class="modal">
            <div class="modal-box">
              ...
              <p class="py-4">
                آیا از حذف دسته بندی محصول
                <span class="text-red-600">{{
                  productCategoryStore.singleProductCategory.title
                }}</span>
                اطمینان دارید ؟
              </p>
              <div class="divider"></div>
              <div class="modal-action flex items-center justify-between">
                ...
                <button
                  ...
                  @click="
                    productCategoryStore.deleteSingleProductCategoryHandler
                  "
                >
                  بله اطمینان دارم
                </button>
...
export default {
  ...
  mounted() {
    this.productCategoryStore.getAllProductCategoryHandler();
  },
};
</script>
